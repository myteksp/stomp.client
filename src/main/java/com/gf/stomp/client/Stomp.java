...
public class Stomp {
	public static StompClient over(@SuppressWarnings("rawtypes") Class clazz, String uri) {
     ...
     */
    public static StompClient over(@SuppressWarnings("rawtypes") Class clazz, String uri, Map<String, String> connectHttpHeaders) {
     ...
     * @return StompClient for receiving and sending messages. Call #StompClient.connect
     */
    public static StompClient over(@SuppressWarnings("rawtypes") Class clazz, String uri, Map<String, String> connectHttpHeaders, Object webSocketClient) {
        try {
